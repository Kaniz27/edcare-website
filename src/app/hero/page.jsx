...
const Hero = () => {
  ...
  return (
    <section className="flex bg-[#eff2f9] flex-col md:flex-row items-center justify-between px-8 md:px-24 py-16 mx-auto max-w-[1400px]">
      {/* Left Content */}
      <div className="flex-1 flex flex-col justify-center space-y-6">
        <p className="bg-white px-5 py-2 rounded-full text-xl flex items-center w-fit">
          <span className="bg-[#38b7a6] rounded-full text-white px-2">⚡</span> Welcome to Online Education
        </p>

        <h1 className="text-4xl md:text-5xl font-bold text-gray-900">
          Start learning from <span className="text-teal-600">the world’s best institutions</span>
        </h1>
      ...
      <div className="flex-1 relative mt-10 md:mt-0 flex justify-center">
        <div className="relative group">
          <Image
            src={heroImg}
            alt="Hero"
            className="rounded-4xl w-full transition-transform duration-500 group-hover:scale-105"
            priority
          />

          <div className="absolute left-10 top-1/2 transform -translate-x-1/2 -translate-y-20 bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
